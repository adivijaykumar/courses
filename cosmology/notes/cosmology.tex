...
\begin{itemize}
	...
	\item $\epsilon_0 = \epsilon^{cr}$ ie $\Omega = 1$ and $E = 0$. The spatial curvature will be zero (flat universe). The scale factor reaches some maximum value and the universe recollapses.
\end{itemize}
