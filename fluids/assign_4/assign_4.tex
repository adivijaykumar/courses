...
\begin{homeworkProblem}[2]
	\begin{itemize}
		...
		\item For point vortex, $ \va{u} = \dfrac{\Gamma}{2 \pi r} \vu{\theta} $. This means,
		\begin{equation*}
		\phi = \int \pdv{\phi}{r} dr + \int \dfrac{1}{r} \pdv{\phi}{\theta} d\theta  = \dfrac{\Gamma \theta}{2 \pi r} +  constant
		\end{equation*}
		For lines of constant $ \phi $,
		\begin{align*}
		\dfrac{\Gamma \theta}{2 \pi r}  &= C_1\\
		\implies r \dv{\theta}{x} - \theta \dv{r}{x} &= 0\\
		\implies  \dfrac{1}{r}\qty(x \dv{y}{x} - y) - \dfrac{\theta}{r} \qty(x + y \dv{y}{x} ) &= 0\\
		\implies \dv{y}{x} &= \dfrac{y + \theta x}{x - \theta y}
		\end{align*}
