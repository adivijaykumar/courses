...
\begin{homeworkProblem}[3]
	As the depth and the width for all three streams is the same and constant, we expect that at the source on top of the mountain, the volume flow gets divided equally between the streams. Writing unsteady Bernoulli between the topmost point and a point at height $ h $ above the bottom,
	\begin{equation}
