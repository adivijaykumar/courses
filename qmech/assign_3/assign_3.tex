...
\begin{homeworkProblem}[2]
	...
	We note that,
	\begin{align*}
	\exp(-i \dfrac{\sigma_2 \beta}{2}) &= \sum_{n=0}^\infty  \dfrac{1}{2n!} \qty(-i \dfrac{ \beta}{2})^{2n} \sigma_2^{2n} + \sum_{n=0}^\infty  \dfrac{1}{(2n+1)!} \qty(-i \dfrac{ \beta}{2})^{2n+1} \sigma_2^{2n+1}\\
	&= \sum_{n=0}^\infty  \dfrac{(-1)^n}{2n!} \qty( \dfrac{ \beta}{2})^{2n} - \sum_{n=0}^\infty  \dfrac{(-1)^n}{(2n+1)!} \qty( \dfrac{ \beta}{2})^{2n+1} \sigma_2 \impliedby \sigma_2^{2n} = 1\\
	\exp(-i \dfrac{\sigma_2 \beta}{2}) &= \cos \dfrac{\beta}{2} - i \sin \dfrac{\beta}{2} \sigma_2\\
	\expval{\exp(-i \dfrac{\sigma_2 \beta}{2})}{0} &= \expval{\exp(-i \dfrac{\sigma_2 \beta}{2})}{1} = \cos \dfrac{\beta}{2}
	\end{align*}
	Hence, we get,
	\begin{equation*}
	\tr U = \cos \dfrac{\beta}{2}(e^{i\qty(\frac{\alpha + \gamma}{2})} + e^{-i\qty(\frac{\alpha + \gamma}{2})} ) = \cos \dfrac{\beta}{2}  \cos \dfrac{\alpha + \gamma}{2}
	\end{equation*}
	But we know that for any rotation matrix
\end{homeworkProblem}
