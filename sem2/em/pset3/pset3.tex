...
\begin{homeworkProblem}[1]
	...
	Consider, 
	\begin{equation*}
	I = \int_0^\infty \dfrac{\dd{R}}{R^{2 \Delta +1 }}  \exp(-\dfrac{r^2}{2 R^2})
	\end{equation*}
	Substitute $ R^2 = \dfrac{r^2}{2 u} \implies \dd{u} = - \dfrac{r^2}{R^3} \dd{R} \implies \dd{R} = - \dfrac{r\dd{u}}{ (2u)^{3/2}}$ ,
	\begin{align*}
	I &= \int_0^\infty  \dfrac{r \dd{u}}{ (2u)^{3/2}} \qty(\dfrac{2u}{r^2})^{\Delta + 1/2}  \exp(-u) \\
	&= \dfrac{2^{\Delta - 1}}{r^\Delta} \int_0^\infty  \dd{u} {u}^{\Delta -1}  \exp(-u) \\
	&= \dfrac{2^{\Delta - 1}}{r^\Delta} \Gamma(\Delta) \qq{;} \qq{for} \Delta > 1
	\end{align*}
\end{homeworkProblem}
